                        ...
                        <div class="tab-pane tabs-animation fade show active" id="tab-content-0" role="tabpanel">
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <form action="{{ route('edit_subject', $postedit->unique_id)}}" method="post">
                                    @csrf
                                        <div class="position-relative row form-group">
                                            ...
                                            {{--  <input type="text" name="id" value="{{ $postedit->id }}" hidden/>  --}}
                                                <input name="subjectname" placeholder="Enter Subject Name" type="text" class="form-control" value="{{ $postedit->subject_name }}" required>
                                            </div>
                                        </div>
                                        <div class="position-relative row form-group">
                                            <label class="col-sm-2 col-form-label">Subject Code</label>
                                            <div class="col-sm-10">
                                                <input name="subjectcode" type="text" placeholder="Enter Subject Code" class="form-control" value="{{ $postedit->subject_code }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="position-relative row form-check">
                                            ...
                                            <center>
                                                       <button type="submit" class="ladda-button mb-2 mr-2 btn btn-shadow btn-warning" data-style="slide-down">
                                                            <span class="ladda-label">Edit Subject</span>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="main-card mb-3 card">
                                            <div class="card-body">
                                                <h5 class="card-title">All Subject</h5>
                                                <?php 
                                                function pick(){
